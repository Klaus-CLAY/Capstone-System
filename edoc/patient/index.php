                    ...
                    <tr>
                        <td >
                            ...
                            <p>Haven't any idea about doctors? no problem let's jumping to 
                                ...
                                Track your past and future appointments history.<br>Also find out the expected arrival time of your doctors or medical consultant.<br><br>
                            </p>
                            
                            <h3>Channel a Doctors Here</h3>
                            <form action="schedule.php" method="post" style="display: flex">

                                <input type="search" name="search" class="input-text " placeholder="Search Doctors and We will Find The Session Available" list="doctors" style="width:45%;">&nbsp;&nbsp;
